...
const About = () => {
  ...
  return (
   <section ref={container} id='about' className='main h-screen w-full bg-zinc-200 flex items-center justify-center'>
      <h1 ref={text} className='text-4xl font-bold italic font-serif scale-y-125'>This is About</h1>
   </section>
  )
}
